...
from recipie.serializers import RecipeSerializer, RecipeDetailSerializer


RECIPES_URL = reverse('recipie:recipe-list')


def image_upload_url(recipe_id):
    """Return URL for recipe image upload"""
    return reverse('recipie:recipe-upload-image', args=[recipe_id])
...
def detail_url(recipe_id):
    ...
    return reverse('recipie:recipe-detail', args=[recipe_id])
